...
async def process_with_gemini(
    ...
    prompt: Annotated[str, Field(description="Instructions for processing the video (transcription, summarization, visual description). Can include timestamps like 00:01:00. Can include questions about the video.")] = "Transcribe the audio from this video, giving timestamps for salient events in the video. Also provide visual descriptions."
) -> str:
...
async def main():
    ...
    print(f"🚀 Starting YouTube MCP server (Gemini) on http://0.0.0.0:{PORT}")
